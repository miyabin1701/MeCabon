================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MecaDoku プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MecaDoku には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MecaDoku アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
MecaDoku.h
   ...
   CMecaDokuApp アプリケーション クラスを宣言します。

MecaDoku.cpp
   これは、アプリケーション クラス CMecaDokuApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MecaDoku.ico
   ...
   アイコンはメイン リソース ファイル MecaDoku.rc に含まれていま
   す。
...
MecaDokuDlg.h, MecaDokuDlg.cpp - ダイアログ
   これらのファイルは CMecaDokuDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MecaDoku.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MecaDoku.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
